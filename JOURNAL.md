...
## Phase 12: Sigil Reorder (2026-02-07)
...
## Dead Flythrough Code Removal (2026-02-07)
...
## Calibration Walk + UI Polish (2026-02-07)
...
## Calibration Walk Implementation (2026-02-07)
...
## Unlimited Depth + Hierarchy-First Viewer (2026-02-06)
...
## Treemap Layout Restored at Every Level (2026-02-06)
...
## Individual Image "Room" View (DELETED)
...
## Phase 11 (continued): Performance + Graph Tests
...
- Fly.io cold start: ~8s (container boot + Python startup + cache preheat). Subsequent requests <50ms.
...
- TestRideStats (5), TestRideEngine (7), TestRideSession (9), TestMergeBand (2), TestDeriveLockSet (1), TestDriftAtPosition (2), TestIntegration (2)
...
- Debug "why" readout: hover any node with backtick+G to see per-contrast breakdown
...
- Exit is stack pop (no network request)
...
- All kept contrasts have stability >= 0.9
